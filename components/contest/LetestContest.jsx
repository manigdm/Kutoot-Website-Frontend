...
const LetestContest = () => {
  ...
  useEffect(() => {
    const fetchCampaigns = async () => {
      setLoading(true);
      try {
        const response = await apiRequest.getCoinCampaigns(null);
            ...
            <div className="contest-wrapper">
              ...
              <div className="contest-wrapper__body">
                ...
                <div className="tab-content mt-50" id="myTabContent">
                  <div className="row contest-filter-wrapper justify-content-between mt-30 mb-none-30">
                      ...
                      {/* <div className="col-lg-3 mb-30">
                        <div className="rang-slider">
                          <span className="caption">Coin Price</span>
